...
class Pycalc(Frame):
    ...
    def evaluate(self):
        try:
            ...
            messagebox.showerror("Error", "no puede dividir por cero")
            self.replaceText("0")
    ...
    def createWidgets(self):
        ...
        self.decimalButton = Button(self, font=("Arial", 18), fg='blue', text=".", highlightbackground='lightgrey', command=lambda: self.append("."))
